...
== Changelog ==
You can find the Release Notes in the [Documentation](https://www.wpcloudplugins.com/wp-content/plugins/out-of-the-box/_documentation/index.html#releasenotes).

== Upgrade Notice ==

= 1.16 =
1.16 is a major update introducing support for multiple accounts. After this update it isn't possible to fallback to an older version. Make a full site backup before upgrading.
