...
function create_upload_button_for_custom_images($option)
{
    ...
    if ('' !== $field_value) {
        ...
        $button_html .= '<a href="javascript:void(0)" class="upload-default">'.__('Default', 'wpcloudplugins').'</a>'."\n";
    }
    ...
    <div class="wrap">
      ...
      <div class="outofthebox-panel outofthebox-panel-right">
              ...
              <div class="outofthebox-accounts-list">
                ...
                if (false === $this->get_processor()->is_network_authorized() || ($this->get_processor()->is_network_authorized() && true === is_network_admin())) {
                    ...
                    <div class='account account-new'>
                      ...
                      <div class='account-info-container'>
                        <div class='account-info'>
                          <span class="account-info-space"><?php echo sprintf(__("The authorization is managed by the Network Admin via the <a href='%s'>Network Settings Page</a> of the plugin", 'wpcloudplugins'), network_admin_url('admin.php?page=OutoftheBox_network_settings')); ?>.</span>
                        </div>
                      </div>
                    </div>   
                    <?php
        ...
        <div id="settings_layout"  class="outofthebox-tab-panel">
          <div class="outofthebox-tab-panel-header"><?php _e('Layout', 'wpcloudplugins'); ?></div>

          <div class="outofthebox-accordion">

            <div class="outofthebox-accordion-title outofthebox-option-title"><?php _e('Loading Spinner & Images', 'wpcloudplugins'); ?>         </div>
            <div>

              <div class="outofthebox-option-title"><?php _e('Select Loader Spinner', 'wpcloudplugins'); ?></div>
              ...
              <div class="outofthebox-option-title"><?php _e('General Loader', 'wpcloudplugins'); ?></div>
              <?php
              ...
              ?>
              <div class="outofthebox-option-title"><?php _e('Upload Loader', 'wpcloudplugins'); ?></div>
              <?php
              ...
              echo create_upload_button_for_custom_images($button);
              ?>
              <div class="outofthebox-option-title"><?php _e('No Results', 'wpcloudplugins'); ?></div>
              <?php
              ...
              echo create_upload_button_for_custom_images($button);
              ?>
              <div class="outofthebox-option-title"><?php _e('Access Forbidden', 'wpcloudplugins'); ?></div>
              <?php
              ...
              echo create_upload_button_for_custom_images($button);
              ?>
              <div class="outofthebox-option-title"><?php _e('Error', 'wpcloudplugins'); ?></div>
              <?php
            ...
            <div class="outofthebox-accordion-title outofthebox-option-title"><?php _e('Color Palette', 'wpcloudplugins'); ?></div>
            <div>

              <div class="outofthebox-option-title"><?php _e('Theme Style', 'wpcloudplugins'); ?></div>
              <div class="outofthebox-option-description"><?php _e('Select the general style of your theme', 'wpcloudplugins'); ?>.</div>
              <select name="skin_selectbox" id="content_skin_selectbox" class="ddslickbox">
                <option value="dark" <?php echo 'dark' === $this->settings['colors']['style'] ? "selected='selected'" : ''; ?> data-imagesrc="<?php echo OUTOFTHEBOX_ROOTPATH; ?>/css/images/skin-dark.png" data-description=""><?php _e('Dark', 'wpcloudplugins'); ?></option>
                <option value="light" <?php echo 'light' === $this->settings['colors']['style'] ? "selected='selected'" : ''; ?> data-imagesrc="<?php echo OUTOFTHEBOX_ROOTPATH; ?>/css/images/skin-light.png" data-description=""><?php _e('Light', 'wpcloudplugins'); ?></option>
              </select>
            ...
            <div class="outofthebox-accordion-title outofthebox-option-title"><?php _e('Icons', 'wpcloudplugins'); ?></div>
            <div>

              <div class="outofthebox-option-title"><?php _e('Icon Set', 'wpcloudplugins'); ?></div>
            ...
            <div class="outofthebox-accordion-title outofthebox-option-title"><?php _e('Lightbox', 'wpcloudplugins'); ?></div>
            <div>
              <div class="outofthebox-option-title"><?php _e('Lightbox Skin', 'wpcloudplugins'); ?></div>
              <div class="outofthebox-option-description"><?php _e('Select which skin you want to use for the Inline Preview', 'wpcloudplugins'); ?>.</div>
              ...
              <div class="outofthebox-option-description"><?php _e("Sets path for switching windows. Possible values are 'vertical' and 'horizontal' and the default is 'vertical", 'wpcloudplugins'); ?>.</div>
              ...
              <div class="outofthebox-option-title">Lightbox <?php _e('Image Source', 'wpcloudplugins'); ?></div>
              <div class="outofthebox-option-description"><?php _e('Select the source of the images. Large thumbnails will load fast once created on your server, (raw) original files can take some time to load', 'wpcloudplugins'); ?>.</div>
              <select type="text" name="out_of_the_box_settings[loadimages]" id="loadimages">
                <option value="thumbnail" <?php echo 'thumbnail' === $this->settings['loadimages'] ? "selected='selected'" : ''; ?>><?php _e('Fast - Large preview thumbnails', 'wpcloudplugins'); ?></option>
              ...
              <div class="outofthebox-option-title"><?php _e('Allow Mouse Click on Image', 'wpcloudplugins'); ?>
              ...
              <div class="outofthebox-option-description"><?php _e('Should people be able to access the right click context menu to e.g. save the image?', 'wpcloudplugins'); ?>.</div>

              <div class="outofthebox-option-title"><?php _e('Lightbox Caption', 'wpcloudplugins'); ?></div>
              <div class="outofthebox-option-description"><?php _e('Choose when the caption containing the title and (if available) description are shown', 'wpcloudplugins'); ?>.</div>
            ...
            <div class="outofthebox-accordion-title outofthebox-option-title"><?php _e('Media Player', 'wpcloudplugins'); ?></div>
            <div> 
              <div class="outofthebox-option-description"><?php _e('Select which Media Player you want to use', 'wpcloudplugins'); ?>.</div>
            ...
            <div class="outofthebox-accordion-title outofthebox-option-title"><?php _e('Custom CSS', 'wpcloudplugins'); ?></div>
            <div>
              <div class="outofthebox-option-title"><?php _e('Custom CSS', 'wpcloudplugins'); ?></div>
              <div class="outofthebox-option-description"><?php _e("If you want to modify the looks of the plugin slightly, you can insert here your custom CSS. Don't edit the CSS files itself, because those modifications will be lost during an update.", 'wpcloudplugins'); ?>.</div>
        ...
        <div id="settings_userfolders"  class="outofthebox-tab-panel">
          <div class="outofthebox-tab-panel-header"><?php _e('Private Folders', 'wpcloudplugins'); ?></div>

          <div class="outofthebox-accordion">

            <div class="outofthebox-accordion-title outofthebox-option-title"><?php _e('Global settings Automatically linked Private Folders', 'wpcloudplugins'); ?> </div>
            <div>
              ...
              <div class="outofthebox-option-title"><?php _e('Create Private Folders on registration', 'wpcloudplugins'); ?>
                <div class="outofthebox-onoffswitch">
              ...
              <div class="outofthebox-option-description"><?php _e('Create a new Private Folders automatically after a new user has been created', 'wpcloudplugins'); ?>.</div>

              <div class="outofthebox-option-title"><?php _e('Create all Private Folders on first visit', 'wpcloudplugins'); ?>
                <div class="outofthebox-onoffswitch">
              ...
              <div class="outofthebox-option-description"><?php _e('Create all Private Folders on first visit', 'wpcloudplugins'); ?>.</div>
              <div class="oftb-warning">
              ...
              <div class="outofthebox-option-title"><?php _e('Update Private Folders after profile update', 'wpcloudplugins'); ?>
                <div class="outofthebox-onoffswitch">
              ...
              <div class="outofthebox-option-description"><?php _e('Update the folder name of the user after they have updated their profile', 'wpcloudplugins'); ?>.</div>

              <div class="outofthebox-option-title"><?php _e('Remove Private Folders after account removal', 'wpcloudplugins'); ?>
                <div class="outofthebox-onoffswitch">
            ...
            <div class="outofthebox-accordion-title outofthebox-option-title"><?php _e('Global settings Manually linked Private Folders', 'wpcloudplugins'); ?> </div>
            <div>

              <div class="oftb-warning">
                <i><strong>NOTICE</strong>: <?php echo sprintf(__('You can manually link users to their Private Folder via the %s[Link Private Folders]%s menu page', 'wpcloudplugins'), '<a href="'.admin_url('admin.php?page=OutoftheBox_settings_linkusers').'" target="_blank">', '</a>'); ?>. </i>
              </div>

              <div class="outofthebox-option-title"><?php _e('Access Forbidden notice', 'wpcloudplugins'); ?></div>
              <div class="outofthebox-option-description"><?php _e("Message that is displayed when an user is visiting a shortcode with the Private Folders feature set to 'Manual' mode while it doesn't have Private Folder linked to its account", 'wpcloudplugins'); ?>.</div>
            ...
            if (!empty($main_account)) {
                ?>
                <div class="outofthebox-accordion-title outofthebox-option-title"><?php _e('Private Folders in WP Admin Dashboard', 'wpcloudplugins'); ?> </div>
                <div>
                  ...
                  <div class="outofthebox-option-description"><?php _e('Enables Private Folders in the Shortcode Builder and Back-End File Browser', 'wpcloudplugins'); ?>.</div>
                  ...
                  <div class="outofthebox-suboptions private-folders-auto <?php echo ('auto' === ($this->settings['userfolder_backend'])) ? '' : 'hidden'; ?> ">
                    <div class="outofthebox-option-title"><?php _e('Root folder for Private Folders', 'wpcloudplugins'); ?></div>
                    <div class="outofthebox-option-description"><?php _e('Select in which folder the Private Folders should be created', 'wpcloudplugins'); ?>. <?php _e('Current selected folder', 'wpcloudplugins'); ?>:</div>
                    <?php
                ...
                if (null !== $account) {
                    ...
                    <div id="root_folder_button" type="button" class="button-primary private-folders-auto-button"><?php _e('Select Folder', 'wpcloudplugins'); ?>&nbsp;<div class='oftb-spinner'></div></div>
                    ...
                    <br/><br/>
                    <div class="outofthebox-option-title"><?php _e('Full Access', 'wpcloudplugins'); ?></div>
                    <div class="outofthebox-option-description"><?php _e('By default only Administrator users will be able to navigate through all Private Folders', 'wpcloudplugins'); ?>. <?php _e('When you want other User Roles to be able do browse to the Private Folders as well, please check them below', 'wpcloudplugins'); ?>.</div>
        ...
        <div id="settings_advanced"  class="outofthebox-tab-panel">
          ...
          ?>
          <div class="outofthebox-option-title"><?php _e('Load Javascripts on all pages', 'wpcloudplugins'); ?>
            <div class="outofthebox-onoffswitch">
            ...
            <div class="outofthebox-option-description"><?php _e('By default the plugin will only load it scripts when the shortcode is present on the page. If you are dynamically loading content via AJAX calls and the plugin does not show up, please enable this setting', 'wpcloudplugins'); ?>.</div>
          </div>

          <div class="outofthebox-option-title"><?php _e('Enable Font Awesome Library v4 compatibility', 'wpcloudplugins'); ?>
            <div class="outofthebox-onoffswitch">
          ...
          <div class="outofthebox-option-title"><?php _e('Enable Gzip compression', 'wpcloudplugins'); ?>
            <div class="outofthebox-onoffswitch">
          ...
          <div class="outofthebox-option-title"><?php _e('Nonce Validation', 'wpcloudplugins'); ?>
            <div class="outofthebox-onoffswitch">
          ...
          <div class="outofthebox-option-description"><?php _e('The plugin uses, among others, the WordPress Nonce system to protect you against several types of attacks including CSRF. Disable this in case you are encountering a conflict with a plugin that alters this system', 'wpcloudplugins'); ?>. </div>
          <div class="oftb-warning">
            <i><strong>NOTICE</strong>: Please use this setting with caution! Only disable it when really necessary.</i>
          </div>

          <div class="outofthebox-option-title"><?php _e('Max Age Cache Request', 'wpcloudplugins'); ?></div>
          <div class="outofthebox-option-description"><?php _e('How long are the requests to view the plugin cached? Number is in minutes', 'wpcloudplugins'); ?>.</div>
          ...
          <div class="outofthebox-option-title"><?php _e('Download method', 'wpcloudplugins'); ?></div>
          <div class="outofthebox-option-description"><?php _e('Select the method that should be used to download your files. Default is to redirect the user to a temporarily url. If you want to use your server as a proxy just set it to Download via Server', 'wpcloudplugins'); ?>.</div>
          ...
          <div class="outofthebox-option-description"><?php _e('When you uninstall the plugin, what do you want to do with your settings? You can save them for next time, or wipe them back to factory settings.', 'wpcloudplugins'); ?>. </div>
          <div class="oftb-warning">
        ...
        <div id="settings_integrations"  class="outofthebox-tab-panel">
          ...
          <div class="outofthebox-accordion">
            ...
            <div>
              ...
              <div class="outofthebox-option-title"><?php _e('Site Key', 'wpcloudplugins'); ?></div>
              ...
              <div class="outofthebox-option-title"><?php _e('Secret Key', 'wpcloudplugins'); ?></div>
          ...
          <div class="outofthebox-accordion">
            ...
            <div class="outofthebox-accordion-title outofthebox-option-title"><?php _e('Video Advertisements (IMA/VAST)', 'wpcloudplugins'); ?> </div>
            <div>
              ...
              <input class="outofthebox-option-input-large" type="text" name="out_of_the_box_settings[mediaplayer_ads_tagurl]" id="mediaplayer_ads_tagurl" value="<?php echo esc_attr($this->settings['mediaplayer_ads_tagurl']); ?>" placeholder="<?php echo __('Leave empty to disable Ads', 'wpcloudplugins'); ?>" />
              ...
              <div class="outofthebox-option-title"><?php _e('Enable Skip Button', 'wpcloudplugins'); ?>
                <div class="outofthebox-onoffswitch">
              ...
              <div class="outofthebox-suboptions ads_skipable <?php echo ('Yes' === $this->settings['mediaplayer_ads_skipable']) ? '' : 'hidden'; ?> ">
                <div class="outofthebox-option-title"><?php _e('Skip button visible after (seconds)', 'wpcloudplugins'); ?></div>
                ...
                <div class="outofthebox-option-description"><?php _e('Allow user to skip advertisment after after the following amount of seconds have elapsed', 'wpcloudplugins'); ?></div>
              </div>
            </div>
          </div>
        ...
        <div id="settings_notifications"  class="outofthebox-tab-panel">
          ...
          <div class="outofthebox-tab-panel-header"><?php _e('Notifications', 'wpcloudplugins'); ?></div>

          <div class="outofthebox-accordion">
            <div class="outofthebox-accordion-title outofthebox-option-title"><?php _e('Download Notifications', 'wpcloudplugins'); ?>         </div>
            <div>
              <div class="outofthebox-option-title"><?php _e('Subject download notification', 'wpcloudplugins'); ?>:</div>
              ...
              <div class="outofthebox-option-title"><?php _e('Subject zip notification', 'wpcloudplugins'); ?>:</div>
              ...
              <div class="outofthebox-option-title"><?php _e('Template download', 'wpcloudplugins'); ?> (HTML):</div>
              <?php
              ob_start();
            ...
            <div class="outofthebox-accordion-title outofthebox-option-title"><?php _e('Upload Notifications', 'wpcloudplugins'); ?>         </div>
            <div>  
              <div class="outofthebox-option-title"><?php _e('Subject upload notification', 'wpcloudplugins'); ?>:</div>
              ...
              <div class="outofthebox-option-title"><?php _e('Template upload', 'wpcloudplugins'); ?> (HTML):</div>
              <?php
              ob_start();
            ...
            <div class="outofthebox-accordion-title outofthebox-option-title"><?php _e('Delete Notifications', 'wpcloudplugins'); ?>         </div>
            <div>
              <div class="outofthebox-option-title"><?php _e('Subject delete notification', 'wpcloudplugins'); ?>:</div>
              ...
              <div class="outofthebox-option-title"><?php _e('Template deletion', 'wpcloudplugins'); ?> (HTML):</div>
            ...
            <div class="outofthebox-accordion-title outofthebox-option-title"><?php _e('Template File line in %filelist%', 'wpcloudplugins'); ?>         </div>
            <div>
              <div class="outofthebox-option-description"><?php _e('Template for File item in File List in the download/upload/delete template', 'wpcloudplugins'); ?> (HTML).</div>
              <?php
              ob_start();
          ...
          <div id="reset_notifications" type="button" class="simple-button blue"><?php _e('Reset to default notifications', 'wpcloudplugins'); ?>&nbsp;<div class="oftb-spinner"></div></div>
        ...
        <div id="settings_permissions"  class="outofthebox-tab-panel">
          <div class="outofthebox-tab-panel-header"><?php _e('Permissions', 'wpcloudplugins'); ?></div>

          <div class="outofthebox-accordion">
            <div class="outofthebox-accordion-title outofthebox-option-title"><?php _e('Change Plugin Settings', 'wpcloudplugins'); ?>         </div>
            <div>
              <?php wp_roles_and_users_input('out_of_the_box_settings[permissions_edit_settings]', $this->settings['permissions_edit_settings']); ?>
            </div>

            <div class="outofthebox-accordion-title outofthebox-option-title"><?php _e('Link Users to Private Folders', 'wpcloudplugins'); ?>        </div>
            <div>
              <?php wp_roles_and_users_input('out_of_the_box_settings[permissions_link_users]', $this->settings['permissions_link_users']); ?>
            </div>

            <div class="outofthebox-accordion-title outofthebox-option-title"><?php _e('See Reports', 'wpcloudplugins'); ?>        </div>
            <div>
              <?php wp_roles_and_users_input('out_of_the_box_settings[permissions_see_dashboard]', $this->settings['permissions_see_dashboard']); ?>
            </div>   

            <div class="outofthebox-accordion-title outofthebox-option-title"><?php _e('See Back-End Filebrowser', 'wpcloudplugins'); ?>        </div>
            <div>
            ...
            <div class="outofthebox-accordion-title outofthebox-option-title"><?php _e('Add Plugin Shortcodes', 'wpcloudplugins'); ?>         </div>
            <div>
              <?php wp_roles_and_users_input('out_of_the_box_settings[permissions_add_shortcodes]', $this->settings['permissions_add_shortcodes']); ?>
            </div>

            <div class="outofthebox-accordion-title outofthebox-option-title"><?php _e('Add Direct links', 'wpcloudplugins'); ?>        </div>
            <div>
              <?php wp_roles_and_users_input('out_of_the_box_settings[permissions_add_links]', $this->settings['permissions_add_links']); ?>
            </div>

            <div class="outofthebox-accordion-title outofthebox-option-title"><?php _e('Embed Documents', 'wpcloudplugins'); ?>        </div>
            <div>
        ...
        <div id="settings_stats"  class="outofthebox-tab-panel">
          <div class="outofthebox-tab-panel-header"><?php _e('Statistics', 'wpcloudplugins'); ?></div>

          <div class="outofthebox-option-title"><?php _e('Log Events', 'wpcloudplugins'); ?>
            <div class="outofthebox-onoffswitch">
          ...
          <div class="outofthebox-option-description"><?php _e('Register all plugin events', 'wpcloudplugins'); ?>.</div>

          <div class="outofthebox-suboptions events_options <?php echo ('Yes' === $this->settings['log_events']) ? '' : 'hidden'; ?> ">
            <div class="outofthebox-option-title"><?php _e('Summary Email', 'wpcloudplugins'); ?>
              <div class="outofthebox-onoffswitch">
            ...
            <div class="outofthebox-option-description"><?php _e('Email a summary of all the events that are logged with the plugin', 'wpcloudplugins'); ?>.</div>
          ...
          <div class="outofthebox-option-title"><?php _e('Google Analytics', 'wpcloudplugins'); ?>
            <div class="outofthebox-onoffswitch">
  ...
  <script type="text/javascript" >
      ...
      $('#resetSettings_button').click(function () {
          ...
          $.ajax({type: "POST",
            url: '<?php echo OUTOFTHEBOX_ADMIN_URL; ?>',
            data: {
              action: 'outofthebox-factory-reset',
              _ajax_nonce: '<?php echo $admin_nonce; ?>'
            },
            complete: function (response) {
              location.reload(true);
