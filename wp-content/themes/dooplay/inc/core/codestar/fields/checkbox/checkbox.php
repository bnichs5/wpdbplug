          ...
          foreach ( $options as $option_key => $option_value ) {
            ...
            if ( is_array( $option_value ) && ! empty( $option_value ) ) {
              ...
              foreach ( $option_value as $sub_key => $sub_value ) {
                ...
                echo '<li><label><input type="checkbox" name="'. esc_attr( $this->field_name( '[]' ) ) .'" value="'. esc_attr( $sub_key ) .'"'. $this->field_attributes() . esc_attr( $checked ) .'/> '. ( $sub_value ) .'</label></li>';
              }
              echo '</ul>';
              echo '</li>';
              ...
              echo '<li><label><input type="checkbox" name="'. esc_attr( $this->field_name( '[]' ) ) .'" value="'. esc_attr( $option_key ) .'"'. $this->field_attributes() . $checked .'/> '. ( $option_value ) .'</label></li>';
