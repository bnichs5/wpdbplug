<div id="dbmovies-dbmvs-application" class="dbmovies-app">
        ...
        <nav class="right" id="dbmovies-settings">
            <ul>
                <li class="dbmvs-credits" style="display:none">
                    <strong><?php _d('Credits'); ?>:</strong> <span id="dbmvs-credits">UNLIMITED</span>
                    <a href="https://ouo.io/RhfiuR" target="_blank" class="dbmvs-update"><i class="dashicons dashicons-plus-alt"></i></a>
                </li>
                <li>
	...
	<marquee>Download Latest and Updated Version Only in <a href="//moviecatsv3.com"></a> MovieCatsV3.com</marquee>
	<!-- Forms -->
