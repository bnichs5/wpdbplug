...
function doo_devmode(){
	return (apply_filters('dooplay_dev_mode', false ) || WP_DEBUG ) ? '' : 'min/';
}
...
if(!function_exists('doo_logo_admin')){
    function doo_logo_admin() {
    	$logo = (dooplay_get_option('adminloginlogo')['url']) ? doo_compose_image_option('adminloginlogo') : DOO_URI ."/assets/img/dooplay_wp.png";
