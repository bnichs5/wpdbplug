    ...
    public static function tablelist_front($post_id = false, $typec = false, $box_id = false){
        if(doo_here_type_links($post_id, $typec) == true){
            ...
            if($results){
                ...
                if(doo_is_true('linksrowshow','siz') == true) $out .= "<th>".__d('File Name & Size')."</th>";
                ...
                foreach($results as $post){
                    ...
                    if($type == $typec){
                        ...
                        if(doo_is_true('linksrowshow','qua') == true) $out .= "<td><strong class='quality'><a href='{$link}' target='_blank'>{$qual}</a></strong></td>";
                        if(doo_is_true('linksrowshow','lan') == true) $out .= "<td><a href='{$link}' target='_blank'>{$lang}</a></td>";
                        if(doo_is_true('linksrowshow','siz') == true) $out .= "<td><a href='{$link}' target='_blank'>{$size}</a></td>";
                        if(doo_is_true('linksrowshow','cli') == true) $out .= "<td>{$clik}</a></td>";
                        if(doo_is_true('linksrowshow','add') == true) $out .= "<td><a href='{$link}' target='_blank'>{$date}</a></td>";
