...
class DT_Widget extends WP_Widget {
	...
	function update( $new_instance, $old_instance ) {
		...
		$instance['dt_nun']    = strip_tags( doo_isset($new_instance,'dt_nun'));
		$instance['dt_tipo']   = strip_tags( doo_isset($new_instance,'dt_tipo'));
		$instance['dt_order']  = strip_tags( doo_isset($new_instance,'dt_order'));
		$instance['dt_rand']   = strip_tags( doo_isset($new_instance,'dt_rand'));
		$instance['dt_layout'] = strip_tags( doo_isset($new_instance,'dt_layout'));
		return $instance;
	}
